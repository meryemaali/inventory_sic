...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Ajouter entité </h4><br><br>



            <form method="post" action="{{ route('entity.store') }}" id="myForm" enctype="multipart/form-data">
                @csrf
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="base_rattachement" class="form-control" type="text"    >
                </div>
            </div>
            <!-- end row -->
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Ajouter entité">
            </form>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                name: {
                    required : 'Veuillez saisir le nom entité',
                },
