...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('entity.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;">Ajouter entité </a> <br>  <br>               

                    <h4 class="card-title">Toutes les entités </h4>
